...
/**
 * The persistent class for the DONOR_BOOKING_PILGRIM database table.
 * 
 */
@Entity
@Table(name="DONOR_BOOKING_PILGRIM")
@NamedQuery(name="DonorBookingPilgrim.findAll", query="SELECT d FROM DonorBookingPilgrim d")
public class DonorBookingPilgrim implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name = "DONOR_BOOKING_ID", sequenceName = "DONOR_BOOKING_PILGRIM_SEQ", allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "DONOR_BOOKING_ID")
