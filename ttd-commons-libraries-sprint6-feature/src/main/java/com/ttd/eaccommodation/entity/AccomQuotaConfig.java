...
/**
 * The persistent class for the ACCOM_QUOTA_CONFIG database table.
 * 
 */
@Entity
@Table(name="ACCOM_QUOTA_CONFIG")
@NamedQuery(name="AccomQuotaConfig.findAll", query="SELECT a FROM AccomQuotaConfig a")
public class AccomQuotaConfig implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name = "ACCOM_QUOTA_CONFIG_ID_SEQ_GENERATOR", sequenceName = "ACCOM_QUOTA_CONFIG_ID_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ACCOM_QUOTA_CONFIG_ID_SEQ_GENERATOR")
