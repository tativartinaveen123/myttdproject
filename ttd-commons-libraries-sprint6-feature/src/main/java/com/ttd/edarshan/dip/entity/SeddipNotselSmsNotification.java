...
/**
 * The persistent class for the SEDDIP_NOTSEL_SMS_NOTIFICATION database table.
 * 
 */
@Entity
@Table(name="SEDDIP_NOTSEL_SMS_NOTIFICATION")
@NamedQuery(name="SeddipNotselSmsNotification.findAll", query="SELECT s FROM SeddipNotselSmsNotification s")
public class SeddipNotselSmsNotification implements Serializable {
	...
	public SeddipNotselSmsNotification() {
	}
