...
/**
 * The persistent class for the DARSHAN_MASTER_PENDING database table.
 * 
 */
@Entity
@Table(name = "DARSHAN_MASTER_PENDING")
@NamedQuery(name = "DarshanMasterPending.findAll", query = "SELECT d FROM DarshanMasterPending d")
public class DarshanMasterPending implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name = "DARSHAN_MASTER_PPID_SEQ_GENERATOR", sequenceName = "DARSHAN_MASTER_PPID_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "DARSHAN_MASTER_PPID_SEQ_GENERATOR")
	@Column(name = "DARSHAN_MASTER_PID")
	private long darshanMasterPid;
	...
	public DarshanMasterPending() {
	}

	public long getDarshanMasterPid() {
		return this.darshanMasterPid;
	}

	public void setDarshanMasterPid(long darshanMasterPid) {
		this.darshanMasterPid = darshanMasterPid;
	}
