...
/**
 * The persistent class for the DARSHAN_QUOTA_CONFIG_ARCHIVE database table.
 * 
 */
@Entity
@Table(name = "DARSHAN_QUOTA_CONFIG_ARCHIVE")
@NamedQuery(name = "DarshanQuotaConfigArchive.findAll", query = "SELECT d FROM DarshanQuotaConfigArchive d")
public class DarshanQuotaConfigArchive implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name = "DARSHAN_QUOTA_CONFIG_AID")
	private long darshanQuotaConfigAid;
	...
	public DarshanQuotaConfigArchive() {
	}

	public long getDarshanQuotaConfigAid() {
		return this.darshanQuotaConfigAid;
	}

	public void setDarshanQuotaConfigAid(long darshanQuotaConfigAid) {
		this.darshanQuotaConfigAid = darshanQuotaConfigAid;
	}
