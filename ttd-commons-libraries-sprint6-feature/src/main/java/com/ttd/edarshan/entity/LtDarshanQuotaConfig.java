 ...
 */
@Entity
@Table(name = "LT_DARSHAN_QUOTA_CONFIG")
@NamedQuery(name = "LtDarshanQuotaConfig.findAll", query = "SELECT d FROM LtDarshanQuotaConfig d")
public class LtDarshanQuotaConfig implements Serializable {
	...
	// bi-directional many-to-one association to LocalDarshanQuotaConfig
	@OneToMany(mappedBy = "ltDarshanQuotaConfig")
	private List<LtDarshanAvailability> ltDarshanAvailability;
	...
	public List<LtDarshanAvailability> getLtDarshanAvailability() {
		return ltDarshanAvailability;
	}

	public void setLtDarshanAvailability(List<LtDarshanAvailability> ltDarshanAvailability) {
		this.ltDarshanAvailability = ltDarshanAvailability;
	}

	public LtDarshanAvailability addLtDarshanAvailability(
			LtDarshanAvailability ltDarshanAvailability) {
		getLtDarshanAvailability().add(ltDarshanAvailability);
		ltDarshanAvailability.setLtDarshanQuotaConfig(this);

		return ltDarshanAvailability;
	}

	public LtDarshanAvailability removeLtDarshanAvailability(
			LtDarshanAvailability ltDarshanAvailability) {
		getLtDarshanAvailability().remove(ltDarshanAvailability);
		ltDarshanAvailability.setLtDarshanQuotaConfig(null);
