...
/**
 * The persistent class for the SEVA_FREQUENCY_MASTER_ARCHIVE database table.
 * 
 */
@Entity
@Table(name="SEVA_FREQUENCY_MASTER_ARCHIVE")
@NamedQuery(name="SevaFrequencyMasterArchive.findAll", query="SELECT s FROM SevaFrequencyMasterArchive s")
public class SevaFrequencyMasterArchive implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="SEVAFRQ_ARCHIVE_SMID_SEQ_GENERATOR", sequenceName="SEVAFRQ_ARCHIVE_SMID_SEQ", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEVAFRQ_ARCHIVE_SMID_SEQ_GENERATOR")
	...
	public SevaFrequencyMasterArchive() {
	}
