...
/**
 * The persistent class for the SEVA_QUOTA_CONFIG database table.
 * 
 */
@Entity
@Table(name="SEVA_QUOTA_CONFIG")
@NamedQuery(name="SevaQuotaConfig.findAll", query="SELECT s FROM SevaQuotaConfig s")
public class SevaQuotaConfig implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="SEVA_QUOTA_CONFIG_SEQ_GENERATOR", sequenceName="SEVA_QUOTA_CONFIG_SEQ", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEVA_QUOTA_CONFIG_SEQ_GENERATOR") 
	@Column(name="SEVA_QUOTA_CONFIG_ID")
	private long sevaQuotaConfigId;
	...
	public SevaQuotaConfig() {
	}

	public long getSevaQuotaConfigId() {
		return this.sevaQuotaConfigId;
	}

	public void setSevaQuotaConfigId(long sevaQuotaConfigId) {
		this.sevaQuotaConfigId = sevaQuotaConfigId;
	}
