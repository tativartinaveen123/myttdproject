...
/**
 * The persistent class for the SEVA_TEMPLE_CALENDAR database table.
 * 
 */
@Entity
@Table(name="SEVA_TEMPLE_CALENDAR")
@NamedQuery(name="SevaTempleCalendar.findAll", query="SELECT s FROM SevaTempleCalendar s")
public class SevaTempleCalendar implements Serializable {
	...
	@Column(name="SEVA_TEMPLE_CALENDAR_ID")
	private long sevaTempleCalendarId;
	...
	public SevaTempleCalendar() {
	}

	public long getSevaTempleCalendarId() {
		return this.sevaTempleCalendarId;
	}

	public void setSevaTempleCalendarId(long sevaTempleCalendarId) {
		this.sevaTempleCalendarId = sevaTempleCalendarId;
	}
